package altlombardisch.auth;

import altlombardisch.user.IUserDao;
...
public class WebSession extends AuthenticatedWebSession {
     ...
     * could be found.
     * @see org.apache.wicket.authroles.authentication.AuthenticatedWebSession#authenticate(String,
     * String)
     */
